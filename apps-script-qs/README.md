...
## ✅ Đã deploy (live) — TÀI KHOẢN MỚI
- **Tài khoản:** `support@dezon.vn` (clasp login)
- **Web app URL:** https://script.google.com/macros/s/AKfycbxrLyKeBpeV1OT4EjwWzyFuew_PUQBPFw0lQOEptA6O5CWqyu4rfIZBGsIie30yOQIV/exec
- Script gắn (bound) vào Sheet `1i91KGVtYyhUPT06ELWC-Bea4_Q4hG7yy5ZbXPXhqncQ` (`Data - App QS Dezon`)
- Script ID: `1WrstxTxjmWdWYaP9hNFsQ6A6D0mYnqXDsu2CnEXghQVqYzqDbi-YpMOz`
- Deployment ID: `AKfycbxrLyKeBpeV1OT4EjwWzyFuew_PUQBPFw0lQOEptA6O5CWqyu4rfIZBGsIie30yOQIV`

### Cập nhật code về sau (từ thư mục này)
```bash
npx clasp push -f
npx clasp redeploy AKfycbxrLyKeBpeV1OT4EjwWzyFuew_PUQBPFw0lQOEptA6O5CWqyu4rfIZBGsIie30yOQIV
```

### Bản cũ (lưu trữ) — maitran@decoxdesign.com
- Sheet `1DDbw4W8v5UelNOQnxjWYJwzaQY7r2U7E44l_pwPlqRo`, Script ID `1C68yD1ofvAFgxFeh2RBrbXdnntmUj2w9BF6IRcN1_0cacn0j4IhtuaDI`
